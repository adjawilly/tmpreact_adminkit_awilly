						...
						<div className="col-md-4 col-xl-3">
							<div className="card mb-3">
								...
								<div className="card-body text-center">
									<img src={'assets/adminkit/img/avatars/avatar-4.jpg'} alt="Christina Mason" className="img-fluid rounded-circle mb-2" width="128" height="128" />
							...
							<div className="card">
								...
								<div className="card-body h-100">
									...
									<div className="d-flex align-items-start">
										<img src={'assets/adminkit/img/avatars/avatar-5.jpg" width="36" height="36" className="rounded-circle me-2'} alt="Vanessa Tucker"/>
									...
									<hr />
									<div className="d-flex align-items-start">
										<img src={'assets/adminkit/img/avatars/avatar.jpg" width="36" height="36" className="rounded-circle me-2'} alt="Charles Hall"/>
										<div className="flex-grow-1">
									...
									<hr />
									<div className="d-flex align-items-start">
										<img src={'assets/adminkit/img/avatars/avatar-4.jpg" width="36" height="36" className="rounded-circle me-2'} alt="Christina Mason"/>
										<div className="flex-grow-1">
									...
									<hr />
									<div className="d-flex align-items-start">
										<img src={'assets/adminkit/img/avatars/avatar-2.jpg" width="36" height="36" className="rounded-circle me-2'} alt="William Harris"/>
										<div className="flex-grow-1">
											...
											<div className="row g-0 mt-1">
												<div className="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src={'assets/adminkit/img/photos/unsplash-1.jpg" className="img-fluid pe-2'} alt="Unsplash"/>
												</div>
												<div className="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src={'assets/adminkit/img/photos/unsplash-2.jpg" className="img-fluid pe-2'} alt="Unsplash"/>
												</div>
											</div>
