...
export default function NavBar(){
    return(
        <nav className="navbar navbar-expand navbar-light navbar-bg fixed-to">
				...
				{/*Mega menu sur le navbar horizontal */}
					...
					<ul className="navbar-nav navbar-align">
							...
							<div className="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
								...
								<div className="list-group">
									<a href="#" className="list-group-item">
										<div className="row g-0 align-items-center">
											<div className="col-2">
												<img src={'assets/adminkit/img/avatars/avatar-5.jpg'} className="avatar img-fluid rounded-circle" alt="Vanessa Tucker" />
											</div>
									...
									<a href="#" className="list-group-item">
										<div className="row g-0 align-items-center">
											<div className="col-2">
												<img src={'assets/adminkit/img/avatars/avatar-2.jpg'} className="avatar img-fluid rounded-circle" alt="William Harris" />
											</div>
											<div className="col-10 ps-2">
									...
									<a href="#" className="list-group-item">
										<div className="row g-0 align-items-center">
											<div className="col-2">
												<img src={'assets/adminkit/img/avatars/avatar-4.jpg'} className="avatar img-fluid rounded-circle" alt="Christina Mason" />
											</div>
											<div className="col-10 ps-2">
									...
									<a href="#" className="list-group-item">
										<div className="row g-0 align-items-center">
											<div className="col-2">
												<img src={'assets/adminkit/img/avatars/avatar-3.jpg'} className="avatar img-fluid rounded-circle" alt="Sharon Lessman" />
											</div>
											<div className="col-10 ps-2">
						...
						<li className="nav-item dropdown">
							...
							<a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="assets/adminkit/img/avatars/avatar.jpg" className="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span className="text-dark">Charles Hall</span>
							</a>
